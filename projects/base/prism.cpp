...
void Prism::draw(const glm::mat4& model, const glm::mat4& projection, const glm::mat4& view) {
...
void Prism::generatevertices(GLfloat *vertices) {
...
glm::vec3 Prism::getpoint(GLfloat v, GLfloat y) {
	glm::vec3 point;
	GLfloat pi = 3.1415f;
